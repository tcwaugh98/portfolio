...
## verification
#print('df_SMB: ',df_SMB)
#print('df_cov_ERP: ', df_cov_ERP)
#print('cov_ERP: ',cov_ERP)
#print('var_mkt: ',var_mkt)
#print('bERP: ', bERP)
#print('ERP: ',ERP)
...
## verification
#print('df_SMB: ',df_SMB)
#print('df_cov_SMB', df_cov_SMB)
#print('cov_SMB: ',cov_SMB)
#print('var_SMB: ',var_SMB)
#print('bSMB: ', bSMB)
#print('SMB: ',SMB)
#SMB = smallcap_return - largecap_return
...
#df_ERP.cov(min_periods=None, ddof=1, numeric_only=_NoDefault.no_default)


#3
# dfERP = pdr.get_data_yahoo()
